...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmp_e6j08nb/repo/precheck_results/25_APR_2026___13_04_40/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp_e6j08nb/repo/precheck_results/25_APR_2026___13_04_40/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp_e6j08nb/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp_e6j08nb/repo/gds/user_project_wrapper.gds
cd /tmp/tmp_e6j08nb/repo/precheck_results/25_APR_2026___13_04_40/tmp_oeb/ext
