...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmp_e6j08nb/repo/precheck_results/25_APR_2026___13_04_40/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp_e6j08nb/repo/precheck_results/25_APR_2026___13_04_40/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmp_e6j08nb/repo/precheck_results/25_APR_2026___13_04_40/tmp/ext
