...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmp_fvalhs8/repo/precheck_results/28_APR_2026___18_29_44/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp_fvalhs8/repo/precheck_results/28_APR_2026___18_29_44/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp_fvalhs8/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp_fvalhs8/repo/gds/user_project_wrapper.gds
cd /tmp/tmp_fvalhs8/repo/precheck_results/28_APR_2026___18_29_44/tmp_oeb/ext
