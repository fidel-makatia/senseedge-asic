...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmp_fvalhs8/repo/precheck_results/28_APR_2026___18_29_44/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp_fvalhs8/repo/precheck_results/28_APR_2026___18_29_44/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmp_fvalhs8/repo/precheck_results/28_APR_2026___18_29_44/tmp/ext
