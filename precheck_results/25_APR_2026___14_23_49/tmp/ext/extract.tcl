...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmp2h04zu9g/repo/precheck_results/25_APR_2026___14_23_49/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp2h04zu9g/repo/precheck_results/25_APR_2026___14_23_49/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmp2h04zu9g/repo/precheck_results/25_APR_2026___14_23_49/tmp/ext
