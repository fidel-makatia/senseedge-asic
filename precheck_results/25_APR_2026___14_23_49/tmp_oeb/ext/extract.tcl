...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmp2h04zu9g/repo/precheck_results/25_APR_2026___14_23_49/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp2h04zu9g/repo/precheck_results/25_APR_2026___14_23_49/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp2h04zu9g/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp2h04zu9g/repo/gds/user_project_wrapper.gds
cd /tmp/tmp2h04zu9g/repo/precheck_results/25_APR_2026___14_23_49/tmp_oeb/ext
