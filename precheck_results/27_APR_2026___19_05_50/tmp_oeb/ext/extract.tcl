...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmpd5bjpsmi/repo/precheck_results/27_APR_2026___19_05_50/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpd5bjpsmi/repo/precheck_results/27_APR_2026___19_05_50/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpd5bjpsmi/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpd5bjpsmi/repo/gds/user_project_wrapper.gds
cd /tmp/tmpd5bjpsmi/repo/precheck_results/27_APR_2026___19_05_50/tmp_oeb/ext
