...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmpd5bjpsmi/repo/precheck_results/27_APR_2026___19_05_50/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpd5bjpsmi/repo/precheck_results/27_APR_2026___19_05_50/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmpd5bjpsmi/repo/precheck_results/27_APR_2026___19_05_50/tmp/ext
