...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmph3329h8i/repo/precheck_results/25_APR_2026___12_48_40/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmph3329h8i/repo/precheck_results/25_APR_2026___12_48_40/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmph3329h8i/repo/precheck_results/25_APR_2026___12_48_40/tmp/ext
