...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmph3329h8i/repo/precheck_results/25_APR_2026___12_48_40/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmph3329h8i/repo/precheck_results/25_APR_2026___12_48_40/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmph3329h8i/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmph3329h8i/repo/gds/user_project_wrapper.gds
cd /tmp/tmph3329h8i/repo/precheck_results/25_APR_2026___12_48_40/tmp_oeb/ext
